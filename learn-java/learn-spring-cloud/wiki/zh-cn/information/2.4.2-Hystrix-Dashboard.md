...
![Hystrix Dashboard](dist/images/hystrix-dashboard-1.png)
...
![Hystrix Dashboard 监控](dist/images/hystrix-dashboard-2.png)

此时我们会看到findById这个API的各种指标。Hystrix Dashboard Wiki上详细说明了图上每个指标的含义，如下图：

![Hystrix Dashboard pic description](dist/images/hystrix-dashboard-3.png)
