...
![turbine-index](learn-java/learn-spring-cloud/wiki/distlearn-java/learn-spring-cloud/wiki/distimages/turbine-01.png)

将会查看到如下的图表，有图可见，我们把两个项目的API都监控了：

![turbine-chart](learn-java/learn-spring-cloud/wiki/distimages/turbine-02.png)
