...
![Consul](learn-java/learn-spring-cloud/wiki/dist/images/consul-1.png)4. 我们尝试访问`http://192.168.11.143/ui/` ，会发现无法访问。说明Consul还不能被远程访问。那么如何设置才能被远程访问呢？Consul如何高可用呢？
