...
如上，我们三个节点都加了`-ui` 参数启动了内建的界面。我们可以通过：`//192.168.11.143:8500/ui/` 或者`//192.168.11.145:8500/ui/`进行访问，也可以在node1机器上通过`//127.0.0.1:8500/ui/` 进行访问，原因是node1没有开启远程访问 ，三种访问方式结果是一致的，如下：
...
>
>  Consul 系列博文：[//www.cnblogs.com/java-zhao/archive/2016/04/13/5387105.html](//www.cnblogs.com/java-zhao/archive/2016/04/13/5387105.html)
>
>  使用consul实现分布式服务注册和发现：[//www.tuicool.com/articles/M3QFven](//www.tuicool.com/articles/M3QFven)
